...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="stylesheet" to="{{ asset('/css/AdminLTE.min.css') }}">
        <link rel="stylesheet" to="{{ asset('/css/all-skins.min.css') }}">
        <link rel="stylesheet" to="{{ asset('/css/toastr.css') }}">
        <link rel="stylesheet" type="text/css" to="{{asset('/css/select2.min.css')}}"/>
        <link rel="stylesheet" to="{{ asset('/css/layout.css') }}">
        <link rel="stylesheet" to="{{ asset('/css/layout-admin.css') }}">
        @yield('css')

    </head>
    
    <body className="hold-transition skin-yellow sidebar-mini fixed">
