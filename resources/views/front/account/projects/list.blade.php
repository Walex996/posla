            ...
            <div className="col-12 col-md-8 col-lg-9">
                ...
                <div className="section">
                    <div className="section-title section-title-sm">
                        Active Projects (6)
                        <Link to="/account/projects/create" className="btn btn-blue btn-sm pull-right">Create New Project</Link>
                    </div>
                    <div>

                        <ul className="nav nav-tabs posla-tabs posla-tabs-2">
                            <li className="nav-item">
                                <Link to="/account/projects/" className="nav-link active">
                            ...
                            <li className="nav-item">
                                <Link to="/account/projects/paused" className="nav-link">
                                    <div className="text-center">
                                        Paused Projects (3)
                                    </div>
                                </Link>
                            ...
                            <div className="col-sm-6 col-md-12 col-lg-6 project-mgmt">
                                ...
                                <div className="dropdown">
                                    ...
                                    <div className="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown" style="margin-top: -20px;">
                                        ...
                                        <Link className="dropdown-item" to="/account/projects/pause/1234">
                                            Pause
                                        </Link>
