                    ...
                    <form method="post" action="" className="form b-1-ddd p-5-10">
                        ...
                        <div className="bt-1-ddd">
                            ...
                            <div className="resolve-cancel d-none">
                                ...
                                <label className="checkbox-inline cursor-pointer d-block b-1-ddd p-2.5 mt-2.5 mr-2.5">
                                    <input type="radio" name="resolve_order_why" className="ml-2.5 pull-left" value="order_again">
                                    <div className="overflow-hidden">
                                ...
                                <label className="checkbox-inline cursor-pointer d-block b-1-ddd p-2.5 mt-2.5 mr-2.5">
                                    <input type="radio" name="resolve_order_why" className="ml-2.5 pull-left" value="more_work_cancel">
                                    <div className="overflow-hidden">
                                ...
                                <label className="checkbox-inline cursor-pointer d-block b-1-ddd p-2.5 mt-2.5 mr-2.5">
                                    <input type="radio" name="resolve_order_why" className="ml-2.5 pull-left" value="too_busy">
                                    <div className="overflow-hidden">
                            ...
                            <div className="modal modal-confirm-more-time">
                                <div className="modal-dialog">
                                    <div className="modal-content">
                                        <div className="modal-header">
                                            <h4 className="modal-title">Request Time Extension - Order Resolution Confirmation</h4>
                                            <button type="button" className="close" data-dismiss="modal">&times;</button>
                                        </div>
                                        <div className="modal-body">
                                            <div className="p-2.5">
                            ...
                            <div className="modal modal-confirm-more-work">
                                <div className="modal-dialog">
                                    <div className="modal-content">
                                        <div className="modal-header">
                                            <h4 className="modal-title">Request Time Extension & Payment - Order Resolution Confirmation</h4>
                                            <button type="button" className="close" data-dismiss="modal">&times;</button>
                                        </div>
                                        <div className="modal-body">
                                            <div className="p-2.5">
