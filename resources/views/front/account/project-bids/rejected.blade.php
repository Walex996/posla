                ...
                <div className="section">
                    ...
                    <div>
                        ...
                        <ul className="nav nav-tabs posla-tabs posla-tabs-3">
                            ...
                            <li className="nav-item">
                                <Link to="/account/project-bids/rejected" className="nav-link active">
                                    <div className="text-center">
                                        Rejected
                                        <span className="d-none d-sm-inline d-md-none d-lg-inline">
                                            Biddings
                        ...
                        <div className="project-list project-list-mini mt-5 row">
                            ...
                            <div className="col-sm-6 col-md-12 col-lg-6 project-mgmt">
                                ...
                                <div className="p-2.5 b-1-ddd bg-blue text-fff">
                                    ...
                                    My Proposal: $550
                                    <label className="d-none d-md-inline d-lg-none d-xl-inline label label-fff label-sm mr-1.5 ml-1.5">
                                        Ignored
                                    </label>
                                    <div className="d-block d-md-none d-lg-block d-xl-none">
                                        <label className="label label-fff label-sm d-inline">
                                            Ignored
                                        </label>
                                    </div>
                                </div>
