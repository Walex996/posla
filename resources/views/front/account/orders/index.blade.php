...
@section('title')
    Orders - Account - Firstname Lastname
@endsection


@section('og')
    <meta name="description" content="Orders - Posla">
    <meta name="keywords" content="orders, user, Posla, Posla.com">
    <meta name="tags" content="orders account user posla posla.com">
