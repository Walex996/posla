                                ...
                                <form action="/account/deals/create/1234/publish">
                                    ...
                                    <div className="b-1-ddd">
                                                ...
                                                <div className="mt-5 deal-crud-requirement-all">
                                                    ...
                                                    {/*start: foreach loop */}
                                                        <div className="deal-crud-requirement">
                                                            ...
                                                            <div>
                                                                <input name="questions[0][question]" className="form-control mt-2.5" type="text" placeholder=" What is your printer configuration format?">
                                                        ...
                                                        <div className="deal-crud-requirement">
                                                            ...
                                                            <div>
                                                                <input name="questions[1][question]" className="form-control mt-2.5" type="text" placeholder="What is your age range?">
                                        ...
                                        <div className="p-15 mt-15 bt-1-ddd floated-content">
                                            <div className="pull-right">
                                                <Link to="/account/deals/create/1234/pricing" className="btn btn-transparent-black btn-sm icon-left">
