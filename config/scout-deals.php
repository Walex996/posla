...
return [
    ...
    */
    ...
    'searchableAttributes' => ['title', 'tags', 'description','owner', 'category', 'subcategory'],
    ...
    */
    ...
    'customRanking' => ['desc(boosted)', 'desc(created_at)', 'desc(updated_at)'],
    ...
    */
    ...
    'attributesForFaceting' => ['category_id', 'subcategory_id'],
