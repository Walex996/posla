...
return [
    ...
    */
    ...
    'customRanking' => ['desc(boosted)','desc(email_verified_at)', 'desc(created_at)', 'desc(updated_at)'],
    ...
    */
    ...
    'attributesForFaceting' => ['country_id'],
    ...
    */
    ...
    'unretrievableAttributes' => ['password', 'remember_token'],
