    ...
    return (
        <div>
            <div className="container mx-auto pt-16">
                <CarouselProvider naturalSlideWidth={100} naturalSlideHeight={125} totalSlides={3} isIntrinsicHeight={true} infinite={true} isPlaying={true} interval={5000}>
                    <Slider>
                        <Slide index={1}>
                            {" "}
                            <figure className="py-4">
                                <div className="flex flex-wrap justify-around">
                                    <div className="xl:w-1/3 lg:w-5/12 w-11/12 sm:w-3/5 md:w-5/12 xl:pb-0 pb-12">
                                        <div className="bg-white shadow-lg mx-3 xl:mx-3 sm:mx-0 lg:mx-0 rounded">
                                            <div className="bg-gray-300 pt-6 pb-6 pl-6 rounded-tl rounded-tr">
                                                <p className="text-xl text-black pb-1">Alex Parkinson</p>
                                                <p className="text-base text-white">AlphaSquad LLC</p>
                                            </div>
                                    ...
                                    <div className="xl:w-1/3 lg:w-5/12 w-11/12 sm:w-3/5 md:w-5/12 xl:mb-0 mb-12">
                                        <div className="bg-white shadow-lg mx-3 xl:mx-3 sm:mx-0 lg:mx-0 rounded">
                                            <div className="bg-gray-300 pt-6 pb-6 pl-6 rounded-tl rounded-tr">
                                                <p className="text-xl text-black pb-1">Ashley Wilson</p>
                                                <p className="text-base text-white">i-Intellect Inc</p>
                                            </div>
                                            <div className="pl-6 pr-6 pt-10 relative h-64">
                                                <div className="h-16 w-16 rounded-full bg-cover border-4 border-white absolute top-0 right-0 -mt-8 mr-6">
                                    ...
                                    <div className="xl:w-1/3 lg:w-5/12 w-11/12 sm:w-3/5 md:w-5/12 xl:mb-0 mb-12">
                                        <div className="bg-white shadow-lg mx-3 xl:mx-3 sm:mx-0 lg:mx-0 rounded">
                                            <div className="bg-gray-300 pt-6 pb-6 pl-6 rounded-tl rounded-tr">
                                                <p className="text-xl text-black pb-1">Richard Clark</p>
                                                <p className="text-base text-white">Apple Inc</p>
                                            </div>
                                            <div className="pl-6 pr-6 pt-10 relative h-64">
                                                <div className="h-16 w-16 rounded-full bg-cover border-4 border-white absolute top-0 right-0 -mt-8 mr-6">
